...
import { operatorNotificationsAPI } from "../../services/api";
...
const TYPE_CONFIG = {
  ...
  package_rejected: { icon: XCircle, color: "text-red-500", bg: "bg-red-50" },
  package_revision: {
    icon: AlertTriangle,
  ...
  useEffect(() => {
    operatorNotificationsAPI
      ...
      .then((res) => {
        ...
        // Mark all as read
        operatorNotificationsAPI.markAllRead().catch(() => {});
      })
      .catch(() => {})
      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center">
          ...
          <p className="text-xs text-gray-400 mt-1">
            You'll see booking updates, approvals, and earnings here
          </p>
        </div>
      ) : (
